...
if(value=="i love you"){
    console.log("User entered love");
    const myImage = document.getElementById("myImage");
    const imageUrl = `https://iili.io/HizL5Ug.jpg`;
...
if(value=="i hate you"){
  ...
  console.log("User entered hate");
  const myImage = document.getElementById("myImage");
  const imageUrl = `https://iili.io/Hiz8sMG.png`;
  const hoverUrl = "https://iili.io/HizUAXe.png";
  myImage.setAttribute("src", imageUrl);
  myImage.setAttribute("data-hover", hoverUrl);
  new Scene();
  canvas.style.display="";
...
if(value=="bhar me jao"){
  console.log("User entered bhar");
  const myImage = document.getElementById("myImage");
  const imageUrl = `https://iili.io/HizZoMB.png`;
  const hoverUrl = "https://iili.io/HiztOmJ.png";
  myImage.setAttribute("src", imageUrl);
  myImage.setAttribute("data-hover", hoverUrl);
  new Scene();
  canvas.style.display="";
...
if(value=="jai shree ram"){
  console.log("User entered Ram");
  const myImage = document.getElementById("myImage");
  const imageUrl = `https://iili.io/HizOqfp.png`;
  const hoverUrl = "https://iili.io/HizOCgI.jpg";
  myImage.setAttribute("src", imageUrl);
  myImage.setAttribute("data-hover", hoverUrl);
  new Scene();
  canvas.style.display="";
